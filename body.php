				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>Electronig<br>Automation</h3>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Motors</a></li>
									<li><a data-toggle="tab" href="#tab1">Scoters</a></li>
									<li><a data-toggle="tab" href="#tab1">Wheels</a></li>
									<li><a data-toggle="tab" href="#tab1">Main</a></li>
								</ul>
							</div>
						</div>
					</div>
